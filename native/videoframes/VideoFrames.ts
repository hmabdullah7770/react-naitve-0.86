...
// TurboModules don't export a separate emitter from the spec file —
// you build it from the native module (default export) itself.
const VideoFramesEmitter = new NativeEventEmitter(NativeVideoFrames);
