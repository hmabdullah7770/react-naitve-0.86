...
import { pushToReadNotificationQueue } from '../../../utils/readNotificationQueue';
...
const NotificationList = () => {
    ...
    // ✅ mutateAsync for queue pattern (same as rating)
    ...
    // ✅ Push to queue instead of direct API call
    const handleNotificationPress = useCallback(async (notification) => {
        if (!notification.isRead) {
            await pushToReadNotificationQueue(notification._id, markAsReadAsync);
        }
